            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                        ...
                        style="margin-top: 60px; margin-bottom: 60px; width: 350px; margin-left: 40px; background-color: #DDEFF5;">
                        <div class="offcanvas-header">
                            <h5 class="offcanvas-title" id="offcanvasExampleLabel">Notice Board</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                                aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body">
                            <div>
                                Important Notice: Inventory System Update
                                <br>
                                Dear Team,
                                <br><br>
                                Please be informed that we will be conducting a system update for our inventory management
                                system starting from [03/04/2024] to [05/04/2024]. During this period, the inventory system
                                will be temporarily unavailable.
                                <br><br>
                                Schedule:
                                <br><br>
                                Start Date: [03/04/2024]<br>
                                End Date: [05/04/2024]<br>
                                Purpose of Update:
                                <br><br>
                                Enhancements to improve system performance.
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('orders.create') }}" class="btn btn-info d-none d-sm-inline-block">
                            <x-icon.plus />
                            Create new order
                        </a>
