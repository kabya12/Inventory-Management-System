...
class PurchaseController extends Controller
{
    ...
    public function updatePayingAmount($purchaseId)
{
    // Retrieve the purchase record from the database
    ...
    // Update the paying amount
    $purchase->update(['paying_amount' => $validatedData['paying_amount']]);

    // Return a success response
    return response()->json(['new_paying_amount' => $purchase->paying_amount]);
}
    ...
    public function updatePaid(Request $request, Purchase $purchase)
    {
        $purchase->update([
            'paying_amount' => $request->paying_amount
        ]);

        return response()->json(['message' => 'Payment amount updated successfully.']);
    }
