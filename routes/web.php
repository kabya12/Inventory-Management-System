...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::put('/purchases/{purchase}/update-paid', [PurchaseController::class, 'updatePaid'])->name('purchases.update-paid');


    Route::put('/update-paying-amount/{purchaseId}', [PurchaseController::class, 'updatePayingAmount'])->name('update-paying-amount');
    ...
    //newly added
    Route::get('/purchases/{purchase}', [PurchaseController::class, 'addpayment'])->name('purchases.addpayment');
